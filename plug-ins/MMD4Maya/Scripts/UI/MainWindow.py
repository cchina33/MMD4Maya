...
class MainWindow(object):
        ...
        if txtFilenames:
            for readmeFile in txtFilenames:
                ...
                if os.path.exists(readmeFile):
                    ...
                    inputFile.close()
                    try:
                        fileName = GetFileNameFromFilePath(readmeFile) + '.txt'
                        self.Log('================================= ' + fileName + ' ===================================')
                        for line in lines:
    ...
    def Log(self, log):
        def WriteToLog(log):
            cmds.scrollField(self.logText, edit = True, insertText = _to_text(log) + '\n')
    ...
    def ShowExplorer(self, type = 'pmd'):
        ...
        ExplorerWindow.show_dialog(parent=widget, type=type, mainWindow=self)
